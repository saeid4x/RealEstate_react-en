...
const Banner = () => {
  return (
    <section className="h-full max-h-[640px] mb-8 xl:mb-24">
      <div className="flex flex-col lg:flex-row border-4 border-indigo-600">
        <div
        ...
        >
          ...
          <p className="max-w-[480px] mb-8">
            ...
            nisi, pharetra vel laoreet at, pharetra in nisl. Duis nec erat a
            arcu maximus convallis a sit amet risus. Morbi lacinia porttitor
            odio et sodales.
          </p>
        </div>
        {/* image */}
